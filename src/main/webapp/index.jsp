                     ...
                     <div class="card-columns">
                         ...
                         <div class="card p-2"  >
                             ...
                             <div class="card-footer text-center">
                                 ...
                                 <span class="ml-2" style="font-size:20px;color:red"><b>PKR</b><%=p.getProductPrice()%></span>
                     ...
                     <div class="card-columns">
                         ...
                         <div class="card p-2"  >
                             ...
                             <div class="card-footer text-center">
                                 ...
                                 <span class="ml-2" style="font-size:20px;color:red"><b>PKR<%=p.getProductPrice()%></b></span>
                                  <span class="ml-2" style="font-size:20px;color:green"><%=p.getProductDiscount() %>% off</span>
                                 </p>
                                  <span class="ml-2" style="font-size:20px;">Stock :</span>
                                  <span class="ml-1" style="font-size:20px"><%if(p.getProductQuantity()<1){ %><span style="color:red;"><b><%=stock%></b></span><%} else{ %><%=p.getProductQuantity()%><% } %></span>
                 ...
                 <div class="col-md-12 admin">
                     <div class="card-columns hover">
                         ...
                         <div class="card">
                             ...
                             <div class="card-footer text-center">
                                 <p style="font-size:25px"><span class="ml-2"><b>PKR<%=Helper.getProductSellingPrice(p.getProductPrice(), p.getProductDiscount()) %>/-</b></span>
                                 <span class="ml-2" style="font-size:20px;color:red"><del>PKR<%=p.getProductPrice()%>/-</del></span>
                                  <span class="ml-2" style="font-size:20px;color:green"><%=p.getProductDiscount() %>% off</span>
                                 </p>
                                  <span class="ml-2" style="font-size:20px;">Stock :</span>
                                  <span class="ml-1" style="font-size:20px"><%if(p.getProductQuantity()<1){ %><span style="color:red;"><b><%=stock%></b></span><%} else{ %><%=p.getProductQuantity()%><% } %></span>
